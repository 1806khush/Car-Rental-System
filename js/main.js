...
(function($) {
    ...
    $(document).ready(function() {
        // Immediately remove loader
        if ($('#ftco-loader').length > 0) {
            $('#ftco-loader').removeClass('show');
        }

        // Only run stellar if the plugin exists
        if ($.fn.stellar) {
            $(window).stellar({
                responsive: true,
        ...
        // Only run Scrollax if the plugin exists
        if ($.Scrollax) {
            $.Scrollax();
        }
        ...
        try {
            ...
            if ($('#map').length > 0 && typeof google !== 'undefined' && typeof google.maps !== 'undefined') {
